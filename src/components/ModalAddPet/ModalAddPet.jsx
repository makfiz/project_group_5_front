...
import NextBtn from 'components/Button/NextButton/NextBtn';
import { useAddPetMutation } from '../../redux/Pet/PetsApi';
import { CancelBtn } from '../Button/CancelButton/CancelBtn';
...
const ModalAddPet = ({ closeModal }) => {
  ...
  const onAddPet = value => {
    ...
    dispatch(useAddPetMutation(formData));
    onClose();
  };
              ...
              <>
                <InputFileWrap>
                  <Label>
                    ...
                    />
                    {stateMachine.avatarErrorIsShown && (
